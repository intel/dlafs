...
cp -raf $PROJECTS_PATH/gstreamer_plugin_openVINO/gst-libs/ocl/kernels rpm_src_dir/usr/lib/x86_64-linux-gnu/libgstcvdl/.
cp -raf $PROJECTS_PATH/gstreamer_plugin_openVINO/gst-libs/models rpm_src_dir/usr/lib/x86_64-linux-gnu/libgstcvdl/.

mkdir -p rpm_src_dir/usr/include/gstcvdl
cp -raf $PROJECTS_PATH/gstreamer_plugin_openVINO/gst-libs/ocl/oclcommon.h rpm_src_dir/usr/include/gstcvdl/.
