...
sudo -E apt install libeigen3-dev libdlib-dev libudev-dev libgstreamer-plugins-good1.0-dev gstreamer1.0-plugins-ugly libgstreamer-plugins-bad1.0-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
