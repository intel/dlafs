...
wget https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-20.2.0.tar.gz
tar zxf intel-mediasdk-20.2.0.tar.gz; mv MediaSDK-intel-mediasdk-20.2.0 MediaSDK
cd MediaSDK
mkdir build
cd build
cmake ..
