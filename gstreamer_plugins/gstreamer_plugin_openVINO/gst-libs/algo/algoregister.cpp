 ...
 void AlgoRegister::init_default_algo()
{
	 ...
	 add_algo(ALGO_OMZ_VEHICLE_LICENSE_PLATE_DETECTION_BARRIER_0106, ALGO_OMZ_VEHICLE_LICENSE_PLATE_DETECTION_BARRIER_0106_NAME);
	 add_algo(ALGO_OMZ_VEHICLE_ATTRIBUTES_RECOGNITION_BARRIER_0039, ALGO_OMZ_VEHICLE_ATTRIBUTES_RECOGNITION_BARRIER_0039_NAME);
